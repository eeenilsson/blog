...
- Show results only once. Values in tables & figures should #not# be repeated in the text.
  - Describe a figure in more general terms in the text (emphasize result).
  - Exception: A very important finding.
...
1. Background
  1.1 Kontext.
  1.2 Varför behövs denna forskning
    1.2.1 Vad vi har
	1.2.3 Vad vi vill ha
  1.3 Uppgift/ vad vi gjorde
  1.4 Syftet med detta arbete
2. Methods: Studiedesign. Definition av exposure, outcome.
3. Result: Hur många inkluderades? Huvudsakliga resultat inklusive siffror.
4. Conclusion: Summering av resultatet. Perspektiv/potentiell nytta/ klinisk relevans.
